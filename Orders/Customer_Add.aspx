<%@ Page Title="" Language="VB" MasterPageFile="~/Orders/MasterPage_Orders.master" AutoEventWireup="false" CodeFile="Customer_Add.aspx.vb" Inherits="Products_Suppliers_View" %>
...
<asp:Content  ID="Content1" ContentPlaceHolderID="ChildContent1" Runat="Server" >
    ...
    <div class="row">
      ...
      <asp:Button ID="Button1"  runat="server" Text="< Back to Customers" class="btn btn-default" CausesValidation="false"/>
    </div>
            <br />
            <br />
    ...
    <br />
     ...
     <ContentTemplate>
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label2" runat="server" Text="Customer Name" Font-Size="Medium" ></asp:Label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please Enter Customer Name" ControlToValidate="txt_customer" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>                                    
                                    <asp:TextBox ID="txt_customer" AutoPostBack="true" class="form-control" runat="server" placeholder="Customer Name"></asp:TextBox>
                                </div>
