...
<div class="panel panel-default">
  ...
  <div class="panel-body">
                            ...
                            <div class="col-xs-2">   
                                ...
                                <div class="form-group">  
                                    <asp:Label ID="Label1" runat="server" Text="Quantity" Font-Size="Medium" ></asp:Label>
                            ...
                            <div class="col-xs-2">   
                                ...
                                <div class="form-group">  
                                    ...
                                    <asp:TextBox ID="txt_total_price" class="form-control" runat="server"  ReadOnly="true"></asp:TextBox>                               
                                </div>
                            </div>
